...
def generate_recap_and_tasks(state: AgentState) -> dict:
    ...
    prompt = ChatPromptTemplate.from_messages([
        ("system", "You are an expert executive assistant whose job is to read raw chat logs "
                   ...
                   "or obligations assigned SPECIFICALLY to {user_name}. Do NOT include tasks assigned to other people. These should be framed as clear, actionable bullet points.\n"
                   "3. **Synthesize**: Write a coherent, paragraph-style narrative for the 'recap' field summarizing the overall team's discussions and decisions.\n\n"
